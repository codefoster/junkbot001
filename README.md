...
- Navigate to `junkbot001` folder
- Select `junkbot001.bot` file
...
msbot clone services --name "junkbot001" --code-dir "." --location <azure region like eastus, westus, westus2 etc.> --sdkLanguage "Node" --folder deploymentScripts/msbotClone --verbose
```
